...
export default function InitialLoader() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-black dark:bg-slate-950 transition-opacity duration-700">
      <div className="relative flex items-center justify-center">
        <div className="w-16 h-16 text-blue-600 animate-pulse">
          <svg
            viewBox="0 0 24 24"
