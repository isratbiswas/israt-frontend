  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-blue-500/30 mt-8 lg:mt-32">
      <section className="px-6 pt-12 md:pt-24 pb-12 text-center max-w-5xl mx-auto">
        <div
          className="inline-flex mt-32 sm:mt-16 items-center gap-2 px-5 py-2.5 mb-8 text-[13px] font-medium border rounded-2xl border-blue-800/10 bg-[#121418] backdrop-blur-md
shadow-[-2px_-2px_6px_rgba(59,130,246,0.25),3px_3px_8px_rgba(59,130,246,0.2)]"
        ...
        <div className="flex justify-center gap-2 md:gap-4 overflow-x-auto pb-4 md:overflow-visible">
          {[
            ...
            <div
              key={i}
              className="flex-shrink-0 w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-2xl overflow-hidden border border-white/10 hover:grayscale-0 transition-all duration-500"
            >
              <Image
                src={src}
                width={128}
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 pb-24 mt-10 md:mt-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 bg-[#0A0A0A] lg:bg-transparent rounded-[2.5rem] overflow-hidden">
          ...
          <div className="col-span-1 lg:col-span-7 bg-[#0A0A0A] rounded-[2.5rem] border border-white/10 p-6 sm:p-10 md:p-16 flex flex-col justify-between relative overflow-hidden min-h-[500px]">
            ...
            <div className="max-w-md mt-10 lg:mt-0 z-10">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-5xl font-medium tracking-tight leading-tight">
                And fortunately it’s a skill you can train & develop.
              </h3>
            </div>

            <div className="relative  mt-20 lg:absolute right-0 bottom-0 lg:right-12 lg:bottom-12 mt-12 lg:mt-0 flex lg:flex-col gap-3 md:gap-4 overflow-x-auto lg:overflow-visible pb-4 lg:pb-0">
              {[
                "/assets/people4.png",
                "/assets/people2.png",
                "/assets/people.png",
